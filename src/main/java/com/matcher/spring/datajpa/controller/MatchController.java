...
import com.matcher.spring.datajpa.model.Match;
import com.matcher.spring.datajpa.repository.MatchRepository;
...
public class MatchController {
    ...
    @GetMapping("/{id}")
	public ResponseEntity<Match> getUserById(@PathVariable("id") long id) {
